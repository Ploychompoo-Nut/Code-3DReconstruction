...
import argparse
import sys
sys.path.append('/workspace/DynUNet')
sys.path.append('/workspace/DynUNet/models')
sys.path.append('/workspace/DynUNet/data')
...
if __name__ == "__main__":
    ...
    root_dir = "/workspace/DynUNet/"                              # todo
    data_dir = "/workspace/DynUNet/dataset/"                                         # todo
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        "--save_path", default=root_dir + "Results/upper_lower/DynUNet/", help="Save dir"
    )
    parser.add_argument(
        # "--save_path_max",
        ...
        # help="Save max dir",
        "--save_path_max",
        default=root_dir + "Results/upper_lower/DynUNet_max/",
        help="Save max dir",
    )
    parser.add_argument("--model_name", default="DynUNet_KIPA", help="Weights name")
    parser.add_argument(
        "--model_name_max", default="DynUNet_KIPA_max", help="Max Weights name"
    )
    parser.add_argument("--model_name1", default="DynUNet_KIPA1", help="Weights name")
    parser.add_argument(
        "--model_name_max1", default="DynUNet_max1", help="Max Weights name"
    )
    parser.add_argument("--log_name", default="DynUNet_KIPA.log", help="Log name")

    # Network options
    parser.add_argument("--name", default='dynunet',  help="model_name")
