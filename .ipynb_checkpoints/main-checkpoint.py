...
import argparse
import sys
sys.path.append('/workspace/U-NET')
sys.path.append('/workspace/U-NET/models')
sys.path.append('/workspace/U-NET/data')
...
if __name__ == "__main__":
    ...
    root_dir = "/workspace/U-NET/"                              # todo
    data_dir = "/workspace/U-NET/dataset/"                                         # todo
    parser.add_argument(
    ...
    parser.add_argument(
        "--Image_Tr_txt",
        default=root_dir + "Txt/Txt_lower/Image_Tr.txt",
        help="train image txt path",
    )
    parser.add_argument(
        "--Image_Te_txt",
        default=root_dir + "Txt/Txt_lower/Image_Te.txt",
        help="test image txt path",
    )
    parser.add_argument(
        "--Label_Tr_txt",
        default=root_dir + "Txt/Txt_lower/Label_Tr.txt",
        help="train label txt path",
    )
    parser.add_argument(
        "--Label_Te_txt",
        default=root_dir + "Txt/Txt_lower/Label_Te.txt",
        help="test label txt path",
    )
    parser.add_argument(
        "--Image_Ts_txt",
        default=root_dir + "Txt/Txt_lower/Image_Ts.txt",
        help="test image txt path",
    )
    parser.add_argument(
        "--Label_Ts_txt",
        default=root_dir + "Txt/Txt_lower/Label_Ts.txt",
        help="train label txt path",
    )
    ...
    parser.add_argument(
        ...
        "--save_path", default=root_dir + "Results/upper_lower/U-NET/", help="Save dir"
    )
    parser.add_argument(
        # "--save_path_max",
        ...
        # help="Save max dir",
        "--save_path_max",
        default=root_dir + "Results/upper_lower/U-NET_max/",
        help="Save max dir",
    )
    parser.add_argument("--model_name", default="U-NET_KIPA", help="Weights name")
    parser.add_argument(
        "--model_name_max", default="U-NET_KIPA_max", help="Max Weights name"
    )
    parser.add_argument("--model_name1", default="U-NET_KIPA1", help="Weights name")
    parser.add_argument(
        "--model_name_max1", default="U-NET_max1", help="Max Weights name"
    )
    parser.add_argument("--log_name", default="U-NET_KIPA.log", help="Log name")

    # Network options
    parser.add_argument("--name", default='unet',  help="model_name")
    ...
    parser.add_argument("--lr", default=0.0004, type=float, help="learning rate")#1e-4
    parser.add_argument(
        "--start_train_epoch", default=50, type=int, help="Start training epoch"
    )
    parser.add_argument(
